...
def classifier(request):
    if request.method == 'POST':
        ...
        full_data = pd.read_csv('C:/Users/Mr Ravi/Desktop/featureselection/projectapp/file.csv')
...
def scatter(request):
    if request.method == 'POST':
        df = pd.read_csv('C:/Users/Mr Ravi/Desktop/featureselection/projectapp/file.csv')
        df = df.drop(df.columns[0],axis=1)
...
def violinplot(request):
    if request.method == "POST":
        x_dim = request.POST.get('column1')
        os.remove("C:/Users/Mr Ravi/Desktop/featureselection/static/Images/plot.png")
        df = pd.read_csv('C:/Users/Mr Ravi/Desktop/featureselection/projectapp/file.csv')
        df = df.drop(df.columns[0],axis=1)
        category = df.columns[-1]
        features = df.columns[0:-1].tolist()
